...
<br>
<div align="center">
<tr><td><a href="\ChitkaraLocalCloud\home.php"><img src="\ChitkaraLocalCloud\Icons\cloud1.png" height="94px" width="110px" alt="ChitkaraLocalCloud"></a></td></tr>
...
/*$a=0;
echo "<script>a=0;</script>";*/
foreach (glob("F:\Server\htdocs\ChitkaraLocalCloud\Files\Videos\mov_*.*") as $filename) {
    $size=FileSizeConvert(filesize($filename));
    $filename2=$filename;$filename3=$filename;
...
/*$a=0;
echo "<script>a=0;</script>";*/
foreach (glob("F:\Server\htdocs\ChitkaraLocalCloud\Files\Images\img_*.*") as $filename) {
    $size=FileSizeConvert(filesize($filename));
    $filename2=$filename;$filename3=$filename;
...
/*$a=0;
echo "<script>a=0;</script>";*/
foreach (glob("F:\Server\htdocs\ChitkaraLocalCloud\Files\Documents\doc_*.*") as $filename) {
    $size=FileSizeConvert(filesize($filename));
    $filename2=$filename;$filename3=$filename;
...
/*$a=0;
echo "<script>a=0;</script>";*/
foreach (glob("F:\Server\htdocs\ChitkaraLocalCloud\Files\Audio\aud_*.*") as $filename) {
    $size=FileSizeConvert(filesize($filename));
    $filename2=$filename;$filename3=$filename;
...
/*$a=0;
echo "<script>a=0;</script>";*/
foreach (glob("F:\Server\htdocs\ChitkaraLocalCloud\Files\Misc\misc_*.*") as $filename) {
    $size=FileSizeConvert(filesize($filename));
    $filename2=$filename;$filename3=$filename;
